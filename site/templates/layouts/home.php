...
<section class="header">
    <div class="header__grid">
      ...
      <div class="header__panel">
        <div class="container container_center">
          <h3 class="header__subheading">Добро пожаловать</h3>
          <h2 class="header__heading">Заголовок такой</h2>
          <p class="header__description">Такой заголовок добро пожаловать заголовок</p>
      ...
      <div class="work__grid">
        <div class="work__cell">
          <div class="work__item work-block">
            ...
            <p class="work-block__description">Проснувшись однажды утром после беспокойного сна, Грегор Замза обнаружил.</p>
            <ul class="work-block__list">
              <li class="work-block__item">Проснувшись однажды утром</li>
              <li class="work-block__item">Проснувшись утром</li>
              <li class="work-block__item">Проснувшись утром</li>
              <li class="work-block__item">Проснувшись однажды</li>
            </ul>
          </div>
        </div>
        <div class="work__cell">
...
<section class="welcome">
  ...
  <p class="welcome__description">Проснувшись однажды утром после беспокойного сна, Грегор Замза обнаружил, что он у себя в постели превратился.</p>
...
<section class="prices">
  <div class="container container_center">
    ...
    <p class="prices__description">Проснувшись однажды утром после беспокойного сна, Грегор Замза обнаружил, что он у себя в постели превратился.</p>
